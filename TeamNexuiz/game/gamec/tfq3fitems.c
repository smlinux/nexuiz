...
self.n_s_c = "ÅÎÅÍÙ flag: carried by";
self.display_item_status2 = 2;
self.impulse = 64;
//self.classname = "info_tfdetect";
self.b_n = "\n";
self.t_s_h = "ÙÏÕÒ flag: base.";
//self.origin = '-80 -60 108';
self.t_s_c = "ÙÏÕÒ flag: carried by";
self.n_s_h = "ÅÎÅÍÙ flag: base.";
self.b_t = "Amnesia\nžŸ CHOOSE YOUR TEAM žŸ\n\n..… BLUE TEAM\n..… ÒÅÄ TEAM \n\n—.… AUTO TEAM\n";
self.b_b = "TeamFortress";
self.n_s_m = "ÅÎÅÍÙ flag: down.";
self.t_s_m = "ÙÏÕÒ flag: down.";
q3fdetect = 1;
info_tfdetect();
};
...
//			return;
	...
	self.d_t = "the ÅÎÅÍÙ ìïóô your flag!\n";		// The enemy stole your flag msg
