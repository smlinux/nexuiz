...
void W_Uzi_Attack (void)
{
	...
	fireBullet (v_forward, 100, 8, IT_UZI);
...
void()	uzi_select_01 =	{weapon_thinkf(-1, 0.3, w_ready); weapon_boblayer1(16, '0 0 0');};
void()	uzi_deselect_01 =	{weapon_thinkf(-1, 0.3, w_clear); weapon_boblayer1(16, '0 20 -40');};
void()	uzi_fire1_01 =	
{
