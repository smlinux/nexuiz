...
void worldspawn (void)
{
	...
	if(world.gravity)
	{
		cvar_set("sv_gravity", ftos(world.gravity));
	}
	else
	...
	// new weapon models
	precache_model ("models/weapons/v_rli.md3");		// incendiary rockets
	precache_model ("models/weapons/v_flamer.md3");		// flamer
	precache_model ("models/weapons/v_bombletts.md3");	// bombletts
	...
	precache_model ("models/weapons/w_bombletts.zym");
	...
	// other stuff
	precache_model ("models/weapons/namekb.mdl");
	precache_sound ("weapons/namek_fire.wav");

	precache_model ("models/misc/shield_s.mdl");

	precache_model ("models/misc/ropebase.mdl");

	// on fire sprites
	precache_model ("models/sprites/fire_base.spr32");
	precache_model ("models/sprites/fire_top.spr32");
	...
	precache_sound ("weapons/shotgun_reload.wav");
...
/* // spawn redirect function; doesn't work!
entity spawn()
{
	entity e;
	e = spawn_real();
